...
<FlashcardDeck
  title="Chapter 13 — Machine Learning for Robots"
  deckId="ch13-ml-for-robots"
  cards={  [
      {
          "front": "What is supervised learning?",
          "back": "Learning a mapping from inputs to outputs from labeled examples."
      },
      {
          "front": "What does a loss function measure?",
          "back": "How wrong a model's prediction is — the number training tries to minimize."
      },
      {
          "front": "What is a policy?",
          "back": "A model that maps observations to actions."
      },
      {
          "front": "When would you reach for an MLP, a CNN, or a transformer?",
          "back": "MLP for generic vectors, CNN for images (sliding learned filters), transformer for relationships across all tokens."
      },
      {
          "front": "What is the sim-to-real gap?",
          "back": "The performance drop when a model trained in simulation meets reality."
      },
      {
          "front": "What is self-supervised learning?",
          "back": "Learning representations from the data itself, without labels."
      }
  ]}
/>
