...
Then open the **Balance & physics** panel and shove the robot — a spring-damper controller keeps
it upright, and a hard enough push topples it before it recovers. That is a (deliberately simple)
version of the balance problem from [Chapter 11](../part3-control/balance-locomotion).

:::note What "works" means here
Three things are real in this demo, and they mirror the whole book:
...
3. **Balance & recovery.** The upright pose is held by a feedback controller, not an animation.
:::
