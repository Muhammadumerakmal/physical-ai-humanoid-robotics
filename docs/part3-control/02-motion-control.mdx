...
<FlashcardDeck
  title="Chapter 10 — Motion Control"
  deckId="ch10-motion-control"
  cards={  [
      {
          "front": "What are the four steps of a feedback loop?",
          "back": "Sense the state, compare with the reference, act on the error, repeat."
      },
      {
          "front": "What do the three terms of a PID controller do?",
          "back": "Proportional reacts to present error, integral erases steady-state error, derivative damps the rate of change."
      },
      {
          "front": "Feedback vs. feedforward?",
          "back": "Feedback corrects measured error; feedforward is an open-loop command computed from a model that anticipates the required effort."
      },
      {
          "front": "What is gravity compensation?",
          "back": "A feedforward torque g(q) that cancels gravity at the current pose."
      },
      {
          "front": "Impedance vs. admittance control?",
          "back": "Impedance commands the robot to act like a spring-damper toward the environment; admittance measures external force and moves in response."
      },
      {
          "front": "What is loop bandwidth, and what limits it?",
          "back": "How fast the loop can track; higher gains raise it, but noise and delay cap it."
      }
  ]}
/>
