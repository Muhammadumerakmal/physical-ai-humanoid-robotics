...
The concepts in this chapter — keeping the center of mass over the support
polygon, sequencing footsteps into a gait, and recovering after a disturbance —
are exactly what the humanoid below is doing. Give it a locomotion command in
plain English and watch the gait play out.

<RobotLab />

:::tip Commands to try
`walk to the cube` · `run to the center then turn left` · `spin` · `balance`.
Notice how the stride and turn stay balanced from start to finish.
:::
...
<FlashcardDeck
  title="Chapter 11 — Balance & Locomotion"
  deckId="ch11-balance-locomotion"
  cards={  [
      {
          "front": "What is the support polygon?",
          "back": "The convex hull of the robot's ground contacts — the safe region for balance."
      },
      {
          "front": "Center of pressure vs. zero-moment point?",
          "back": "The CoP is where the ground reaction force actually acts; the ZMP is where the net moment of inertial and gravity forces is zero. They coincide while the robot is balanced."
      },
      {
          "front": "Why is the inverted pendulum the canonical walker model?",
          "back": "A mass on a massless rod balancing above a pivot captures the essential dynamics of a biped's center of mass."
      },
      {
          "front": "What is the capture point?",
          "back": "The spot on the ground where stepping lets a walking robot come to a stop without falling."
      },
      {
          "front": "What is sim-to-real, and what helps it succeed?",
          "back": "Training a policy in simulation and transferring it to hardware; domain randomization helps it generalize."
      }
  ]}
/>
