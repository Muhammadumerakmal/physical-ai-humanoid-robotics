...
<FlashcardDeck
  ...
  deckId="ch7-computer-vision"
  cards={  [
      {
          "front": "What does the pinhole camera model describe?",
          "back": "How a 3D point projects to a 2D pixel through a single focal point."
      },
      {
          "front": "Camera intrinsics vs. extrinsics?",
          "back": "Intrinsics are focal length, principal point, and distortion (pixels-to-rays); extrinsics are the camera's pose in the world."
      },
      {
          "front": "Classical features vs. a CNN?",
          "back": "Classical features are hand-designed detectors (SIFT, HOG, ORB); a CNN learns feature extractors from data."
      },
      {
          "front": "Object detection vs. segmentation?",
          "back": "Detection draws labeled boxes around objects; segmentation labels every pixel (semantic = class, instance = individual object)."
      },
      {
          "front": "What is disparity and what does it encode?",
          "back": "The pixel difference between the two images of a stereo pair; it encodes depth."
      }
  ]}
/>
