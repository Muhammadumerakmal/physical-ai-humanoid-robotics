...
<FlashcardDeck
  title="Chapter 22 — Isaac Sim"
  deckId="ch22-isaac-sim"
  cards={  [
      {
          "front": "What is Isaac Sim?",
          "back": "NVIDIA's GPU-accelerated robot simulator built on the Omniverse platform."
      },
      {
          "front": "What is USD, and why does Isaac use it?",
          "back": "Universal Scene Description — a scalable format for composing complex 3D scenes."
      },
      {
          "front": "What is Isaac Lab?",
          "back": "A framework on Isaac Sim for defining and training reinforcement-learning robot environments."
      },
      {
          "front": "Why is GPU parallelism a big deal for RL?",
          "back": "It runs thousands of environment copies simultaneously on one GPU, massively speeding up training."
      },
      {
          "front": "What do Replicator and Isaac ROS do?",
          "back": "Replicator generates synthetic training data from simulated scenes; Isaac ROS runs GPU-accelerated perception on the real robot."
      }
  ]}
/>
