...
<FlashcardDeck
  title="Chapter 21 — Simulation"
  deckId="ch21-simulation"
  cards={  [
      {
          "front": "What does a physics engine simulate?",
          "back": "Rigid-body motion, contacts, and forces over time."
      },
      {
          "front": "What is a simulation step?",
          "back": "The time increment (e.g. 1 ms) between successive physics updates."
      },
      {
          "front": "What does a contact model compute?",
          "back": "Contact forces from penetration, velocity, and friction."
      },
      {
          "front": "What is a sensor model?",
          "back": "A function that converts ground-truth world state into a realistic, noisy sensor reading."
      },
      {
          "front": "What is domain randomization, and what gap does it fight?",
          "back": "Randomizing simulator parameters so a policy transfers to reality — fighting the sim-to-real gap, the systematic difference between simulated and real behavior."
      }
  ]}
/>
