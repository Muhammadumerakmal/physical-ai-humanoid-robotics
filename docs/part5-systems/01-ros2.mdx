...
<FlashcardDeck
  title="Chapter 19 — ROS 2"
  deckId="ch19-ros2"
  cards={  [
      {
          "front": "What is a node in ROS 2?",
          "back": "A single process in the robot graph that does one job and talks to others."
      },
      {
          "front": "Topic vs. service vs. action?",
          "back": "A topic is many-to-many pub/sub for streams; a service is one-shot request/response; an action is a long-running, cancellable task with goal, feedback, and result."
      },
      {
          "front": "What is DDS in ROS 2?",
          "back": "Data Distribution Service — the discovery and transport layer beneath ROS 2."
      },
      {
          "front": "What does QoS control?",
          "back": "Reliability, durability, and delivery guarantees on a topic."
      },
      {
          "front": "What does TF2 track?",
          "back": "The pose of every coordinate frame on the robot over time."
      },
      {
          "front": "What is a launch file?",
          "back": "A declarative script that starts a whole set of nodes and their parameters at once."
      }
  ]}
/>
