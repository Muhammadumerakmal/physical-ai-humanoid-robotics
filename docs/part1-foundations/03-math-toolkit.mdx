...
<FlashcardDeck
  title="Chapter 3 — Math Toolkit"
  deckId="ch3-math-toolkit"
  cards={  [
      {
          "front": "What does a rotation matrix do, and what makes it special?",
          "back": "It rotates a vector without stretching it; it is orthogonal (its transpose is its inverse)."
      },
      {
          "front": "What does a 4×4 homogeneous transform pack together?",
          "back": "A rotation and a translation in a single matrix, so poses can be composed by multiplication."
      },
      {
          "front": "What does the gradient of a function point toward?",
          "back": "The direction of steepest increase of the function."
      },
      {
          "front": "How does gradient descent minimize a cost?",
          "back": "By stepping in the direction opposite the gradient, downhill, repeatedly."
      },
      {
          "front": "Why is the Gaussian distribution central to robotics?",
          "back": "It models noisy sensor readings and is the assumption behind estimators like the Kalman filter."
      },
      {
          "front": "What does Bayes' rule let a robot do?",
          "back": "Update a belief (a probability) when new evidence arrives."
      }
  ]}
/>
