...
<FlashcardDeck
  title="Chapter 4 — Humanoid Architecture"
  deckId="ch4-humanoid-architecture"
  cards={  [
      {
          "front": "What is an actuator on a humanoid?",
          "back": "The motor plus transmission that produces torque at a joint."
      },
      {
          "front": "What is a series elastic actuator and why use one?",
          "back": "A motor with a spring in line; the spring makes the joint compliant and shock-tolerant."
      },
      {
          "front": "What makes quasi-direct-drive actuators useful?",
          "back": "A low-ratio transmission gives high backdrivability, so the joint can sense and yield to contact forces."
      },
      {
          "front": "Proprioceptive vs. exteroceptive sensors?",
          "back": "Proprioceptive sensors read the robot's own state (encoders, IMUs, force–torque); exteroceptive sensors read the world (cameras, LiDAR, microphones)."
      },
      {
          "front": "What is the thermal budget of a humanoid?",
          "back": "How much heat the body can dissipate while computing and moving — a hard limit on sustained power."
      }
  ]}
/>
