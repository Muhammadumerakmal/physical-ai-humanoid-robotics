...
export const ROBOT_SKILLS = [
  ...
  {skill: 'high_five', params: '{}', desc: 'raise a hand for a high five'},
  ...
  {skill: 'run', params: '{"target": "cube" | "center" | "left" | "right" | "forward"}', desc: 'run toward a target (faster walk)'},
  {skill: 'come_here', params: '{}', desc: 'walk toward the viewer/camera'},
  {skill: 'turn', params: '{"direction": "left" | "right"}', desc: 'turn 90 degrees in place'},
  {skill: 'spin', params: '{}', desc: 'spin a full 360 degrees'},
  ...
  {skill: 'throw', params: '{}', desc: 'throw the held object forward (pick it up first)'},
  {skill: 'kick', params: '{}', desc: 'kick the cube forward (walk to it first)'},
  {skill: 'jump', params: '{}', desc: 'crouch and jump straight up'},
